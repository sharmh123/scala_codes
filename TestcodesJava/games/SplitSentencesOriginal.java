...
public class SplitSentencesOriginal {

    private static final int NUM_WORDS_PER_SENTENCE = 15;
    private static final String BLANK_SPACES_REGEX = "\\s+";
    private static final String BASE_DIR = "/Users/himash/Downloads/sentences";
    ...
    @Builder
    private SplitSentencesOriginal(final int startIndex, final int endIndex, final @NonNull String inputFileName) {
    ...
    public static void main(final String[] args) throws IOException, NumberFormatException, TextException {
        ...
        final SplitSentencesOriginal game = SplitSentencesOriginal.builder()
